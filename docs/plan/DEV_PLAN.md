> ⚠️ **ARCHIVED** — เอกสารวางแผน Phase 0–7 ที่เสร็จสมบูรณ์แล้วทั้งหมด (มิถุนายน 2569)  
> สถานะปัจจุบัน: ดูที่ `PROJECT_STATUS.md` | ประวัติ: ดูที่ `CHANGELOG.md`  
> หมายเหตุ: เอกสารนี้ยังอ้างอิง Next.js 14 (จริงคือ 16) และ schema เก่าก่อนระบบ Plan/Payment/Referral
