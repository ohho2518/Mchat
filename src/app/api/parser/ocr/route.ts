...
รูปแบบ: "[ประเภท][รายละเอียด] [จำนวนเงิน] บาท [วันที่จริงจากสลิปถ้าเห็น]"

กฎสำคัญเรื่องวันที่:
- ถ้าเห็นวันที่ชัดเจนในสลิป ให้ใส่เป็น DD/MM/YYYY เท่านั้น เช่น "04/06/2568" หรือ "4 มิถุนายน 2568"
- ห้ามใช้คำว่า "วันนี้" หรือ "วันที่" โดยไม่มีตัวเลขตามหลัง
- ถ้าไม่เห็นวันที่ ให้ละไว้ ไม่ต้องเดา

ตัวอย่าง:
- สลิปโอน มีวันที่: "โอนเงิน ค่าสินค้า 1500 บาท 04/06/2568"
- สลิปโอน ไม่มีวันที่: "โอนเงิน ค่าสินค้า 1500 บาท"
